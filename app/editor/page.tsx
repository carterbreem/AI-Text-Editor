...
export default function EditorPage() {
  ...
  const handleReplace = async () => {
    ...
    try {
      ...
      // ---- Step 1: crop a padded region around the target text ----
      ...
      // ---- Step 2: ask Qwen to erase the old text in the crop ----
      ...
      try {
        ...
        console.warn("Qwen erase failed, using canvas fill:", apiErr);
      ...
      // ---- Step 3: paste cleaned crop back onto full image ----
      ...
      // ---- Step 4: draw the new text with matched styling ----
...
/** Simple local fallback: fill the bbox area with an average color. */
async function canvasFill(
  ...
  // Sample top + bottom rows for background color
  let r = 0,
    g = 0,
    b = 0,
    n = 0;
